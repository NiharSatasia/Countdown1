...
const bookList = [
  ...
  const add = (bookObject) => bookList.push(bookObject)
  const remove = (bookObject) => bookList.pop(bookObject)
  const print = () => bookList.forEach(title, element => console.log(element))
